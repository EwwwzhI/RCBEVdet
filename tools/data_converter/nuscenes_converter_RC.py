...
def create_nuscenes_infos(root_path,
    ...
    train_nusc_infos, val_nusc_infos = _fill_trainval_infos(             #MMD3D generate .pkl  data
...
def _fill_trainval_infos(nusc,
    ...
    for sample in mmcv.track_iter_progress(nusc.sample):
        ...
        for radar_name in radar_names:
            ...
            # load multi-radar sweeps into sweeps once sweeps < 10
            while len(sweeps) < 10:
