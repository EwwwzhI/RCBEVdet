...
class NuScenesDatasetRC(Custom3DDatasetradar):
    r"""NuScenes Dataset.
    ...
    def get_data_info(self, index):
        ...
        input_dict = dict(
            ...
            radar=info['radars'], # get radar
            location=info["location"],
            ego_t=info['lidar2ego_translation'],
            ego_r=info['lidar2ego_rotation'],
            global_t=info['ego2global_translation'],
            global_r=info['ego2global_rotation'],
        ...
        cam_ego2global = np.eye(4).astype(np.float32)
        cam_ego2global[:3, :3] = Quaternion(info['cams']['CAM_FRONT']['ego2global_rotation']).rotation_matrix
        cam_ego2global[:3, 3] =  info['cams']['CAM_FRONT']['ego2global_translation']
        input_dict["cam_ego2global"] = cam_ego2global
